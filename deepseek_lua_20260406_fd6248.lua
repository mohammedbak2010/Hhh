...
local function CreateSideButton(text, side, index, getState, startFn, stopFn)
    ...
    elseif text == "AUTO TP DOWN" then descText = "نزول"
    end
...
CreateSideButton("AUTO TP DOWN", "right", 4, function() return TPSettings.Enabled end,
    function() 
...
Notify("H2N Ultimate | ✅ Auto Track مع Auto Bat | ✅ Unwalk (حركة + ضرب) | ✅ Auto TP Down | ✅ 7 أزرار جانبية")
print("=" .. string.rep("=", 65))
