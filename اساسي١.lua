-- H2N | Ultimate Edition | FINAL VERSION
-- ✅ إحداثيات L2 = (-484, -5, 96) | R2 = (-484, -5, 24)
-- ✅ Speed Boost يطفى تلقائياً عند تشغيل Auto Play/Auto Track
...
local function startSpeedBoost()
    ...
    speedConn = RunService.Heartbeat:Connect(function()
        ...
        -- لا تتدخل لما Auto Play شغال (يتعاركون على الـ velocity)
        if State.AutoPlayLeft or State.AutoPlayRight then return end
        local char = LP.Character
        if not char then return end
...
local function StartTrackToggle()
    ...
    -- ✅ إيقاف Speed Boost تلقائياً عند تشغيل Auto Track
...
-- ========== [ WAYPOINTS - تم تحديث L2 و R2 ] ==========
local L1    = Vector3.new(-476, -7,  93)
local L2    = Vector3.new(-484, -5,  96)   -- ✅ تم التحديث
local L_END = Vector3.new(-476, -6,  21)
local R1    = Vector3.new(-476, -7,  28)
local R2    = Vector3.new(-484, -5,  24)   -- ✅ تم التحديث
...
Notify("H2N Ultimate | ✅ FINAL VERSION | Speed Boost auto-off when Auto Play ON")
print("=" .. string.rep("=", 65))
print("✅ H2N ULTIMATE - FINAL VERSION")
print("1. ✅ L2 = (-484, -5, 96) | R2 = (-484, -5, 24)")
print("2. ✅ Speed Boost turns OFF automatically when Auto Play ON")
print("3. ✅ Auto Play turns OFF automatically when Speed Boost ON")
print("4. ✅ All features working")
print("=" .. string.rep("=", 65))
print("📌 KEYBINDS:")
