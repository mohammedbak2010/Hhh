-- H2N - ULTIMATE SCRIPT (FULLY FIXED)
    ...
    floatConn = RunService.Heartbeat:Connect(function()
        ...
        if elapsed < 4 then
            if currentY < FloatHeight - 0.3 then
                verticalVel = math.min((FloatHeight - currentY) * 10, 50)
            ...
            verticalVel = -20
            if currentY <= FloatHeight - 10 then
        ...
        hrp.AssemblyLinearVelocity = Vector3.new(hrp.AssemblyLinearVelocity.X, verticalVel, hrp.AssemblyLinearVelocity.Z)
    end)
    Notify("FLOAT ON")
end
