...
local AP_LEND   = Vector3.new(-483.12, -4.95,  94.80)
local AP_LFINAL = Vector3.new(-476,    -7,      22)
local AP_R1     = Vector3.new(-476,    -6,      28)
local AP_REND   = Vector3.new(-483,    -5,      26)
local AP_RFINAL = Vector3.new(-476.17, -7.91,  97.91)
