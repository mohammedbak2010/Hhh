...
local AP_R1     = Vector3.new(-476,    -7,      27)    -- r1 (updated)
...
-- دوال شكل الأزرار - معرّفة هنا عشان Visual tab يقدر يستدعيها
...
do -- Button Shape Picker
    ...
    -- الأزرار الثلاثة: مربع ■  دائري ●  مستطيل ▬
    local shapes = {
    ...
    -- ثلاثة أزرار بجانب بعض على اليمين
