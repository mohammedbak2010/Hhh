-- H2N ULTIMATE - FINAL COMPLETE VERSION
...
local function stopFeaturesOnDamage()
    ...
    if damageCooldownTimer then task.cancel(damageCooldownTimer) end
...
LP.CharacterAdded:Connect(function(char)
    ...
    damageCooldown = false
    lastHealth = nil
    if damageCooldownTimer then damageCooldownTimer:Disconnect(); damageCooldownTimer = nil end
    setupDamageTracking()
end)
...
Notify("H2N ULTIMATE - COMPLETE VERSION")
print("===============================================================")
print("H2N ULTIMATE - FIXED VERSION")
print("1. Auto Track <-> Auto Play switch both ways correctly")
print("2. Float <-> Auto Track mutual exclusion fixed")
print("3. DROP pauses SPEED BOOST for 0.45s then restores")
print("4. Damage detection cooldown: 2.8s (no re-trigger during cooldown)")
print("5. Auto Track does NOT stop on damage (only AutoPlay + Float stop)")
print("===============================================================")
print("KEYBINDS: G=Left | H=Right | F=Float | B=Speed | J=Jump | K=AntiRagdoll | U=Unwalk | T=TP Down")
print("===============================================================")