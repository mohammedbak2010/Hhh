...
-- ============================================
-- SPEED BOOST (FIXED - from Silent Duels)
-- ============================================
local function startSpeedBoost()
    ...
    speedConn = RunService.Heartbeat:Connect(function()
        ...
        local targetSpeed = SpeedSettings.NormalSpeed
...
local function startFloat()
    ...
    floatConn = RunService.Heartbeat:Connect(function()
        ...
        local moveSpeed = SpeedSettings.NormalSpeed
        local moveDir = hum.MoveDirection
        ...
        if floatDescending then
            ...
            local diff = FloatHeight - currentY
            if diff > 0.3 then
                verticalVel = math.clamp(diff * 8, 5, 50)
            elseif diff < -0.3 then
                verticalVel = math.clamp(diff * 8, -50, -5)
            else
                verticalVel = 0
            end
        end
        ...
        hrp.AssemblyLinearVelocity = Vector3.new(horizX, verticalVel, horizZ)
    end)
...
Notify("H2N v7.0 - SpeedBoost & Float from Silent Duels")
print("===============================================================")
print("H2N ULTIMATE v7.0")
print("- SpeedBoost: Smooth and stable (no glitching)")
print("- Float: Fixed from Silent Duels (rises then descends)")
