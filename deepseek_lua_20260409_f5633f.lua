-- H2N - ULTIMATE SCRIPT (Fixed Float)
...
-- ============================================
-- FLOAT (Stops exactly at height 12 - FIXED)
-- ============================================
...
local function startFloat()
    ...
    FloatConn = RunService.Heartbeat:Connect(function()
        ...
        -- If at or above target height, lock position and stop vertical movement
        elseif currentY >= FloatHeight - 0.3 then
            -- Lock position exactly at FloatHeight
...
Notify("H2N v8.0 - All Features Working | Float fixed at height 12")
print("===============================================================")
...
print("- Hit Circle, Spam Bat, Optimizer: Working")
print("===============================================================")