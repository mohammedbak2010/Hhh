-- H2N | Ultimate Edition | FULLY FIXED
-- ✅ تحسين استجابة الأزرار الجانبية (Auto Play Left/Right)
-- ✅ إحداثيات جديدة:
--    L1 = (-476, -7, 93)
--    L2 = (-485, -5, 95)
--    L_END = (-475, -7, 18)
...
local function startSpeedBoost()
    if State.AutoPlayLeft or State.AutoPlayRight or TrackSettings.Enabled then
        Notify("⚠️ أوقف Auto Play/Track أولاً")
        return
    end
...
-- ========== [ MAKE TOGGLE - تحسين استجابة الأزرار ] ==========
local function MakeToggle(parent, text, order, cb, getState, featureName)
    ...
    local function UpdateButton()
        btn.Text = getState() and "ON" or "OFF"
        btn.BackgroundColor3 = getState() and Colors.DarkGray or Colors.White
        btn.TextColor3 = getState() and Colors.White or Colors.Text
    end
...
-- ====== SIDE BUTTONS (6 أزرار - تحسين استجابة اللمس) ======
...
Notify("H2N Ultimate | ✅ Speed Boost & Auto Play Conflict Fixed | ✅ New Coordinates")
print("=" .. string.rep("=", 65))
print("✅ H2N ULTIMATE - FULLY FIXED")
...
print("2. ✅ Speed Boost auto-off when Auto Play ON")
print("3. ✅ Auto Play auto-off when Speed Boost ON")
print("4. ✅ Button response improved")
print("=" .. string.rep("=", 65))
print("📌 KEYBINDS:")
