-- H2N - ULTIMATE SCRIPT (Full Features)
...
-- FLOAT (Stops exactly at height 12)
local FloatHeight = 12
local FloatUpSpeed = 70
local FloatConn = nil
local floatLock = false
...
local function startFloat()
    ...
    FloatConn = RunService.Heartbeat:Connect(function()
        ...
        elseif currentY > targetY + 0.5 and not floatLock then
...
print("- Auto Play Left/Right: Waypoints")
