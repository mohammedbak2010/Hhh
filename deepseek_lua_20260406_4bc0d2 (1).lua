...
local TrackSettings = {
    ...
    LockSpeed = 80,
    TrackSpeed = 58,
    ForwardOffset = 2.3,        -- ✅ النظام القديم (يقف خلف الخصم)
    ExtraForward = 0.45,         -- ✅ تقدم إضافي بسيط
    TrackConn = nil,
    AntiWallConn = nil,
    AlignOri = nil,
    Attachment = nil,
...
-- ========== [ UNWALK (يزيل أنيميشن الحركة فقط) ] ==========
...
local function startUnwalk()
    ...
    if animateScript and animateScript:IsA("LocalScript") then
        ...
        unwalkActive = true
        Notify("🚫 UNWALK ON (الأنيميشن مقفل)")
    else
        Notify("⚠️ ما لقيت سكريبت Animate")
    end
end
...
-- ====== SIDE BUTTONS (6 أزرار فقط، بدون Unwalk) ======
...
-- إنشاء الأزرار الجانبية (6 أزرار فقط، بدون Unwalk)
...
Notify("H2N Ultimate | ✅ Menu Fixed | ✅ Auto Track مع Auto Bat | ✅ Unwalk (أنيميشن فقط) | ✅ بدون زر جانبي لـ Unwalk")
print("=" .. string.rep("=", 65))
...
print("3. ✅ Unwalk (يزيل أنيميشن الحركة فقط - ما يأثر على الحركة)")
print("4. ✅ بدون زر جانبي لـ Unwalk (فقط من القائمة أو زر U)")
print("=" .. string.rep("=", 65))
print("📌 KEYBINDS:")
