...
local function StartAutoPlayLeft()
    ...
    -- لو AutoTrack شغال، طفّه أولاً وانتظر قليلاً عشان يوقف صح
...
print("===============================================================")
print("H2N ULTIMATE - v2 FIXED")
print("FIX 1: AutoPlay <-> AutoTrack تبديل صح في الاتجاهين")
print("FIX 2: Float <-> AutoTrack تبديل صح في الاتجاهين")  
print("FIX 3: DROP - speed boost يرجع بعد 0.35s تأخير بعد تنفيذ الـ drop")
print("FIX 4: Damage cooldown 2.8s مصلح (task.cancel بدل Disconnect)")
print("===============================================================")