...
local L2    = Vector3.new(-485, -5,  95)  -- ✅ تم التحديث
local L_END = Vector3.new(-475, -7,  18)  -- ✅ تم التحديث
local R1    = Vector3.new(-476, -7,  28)
local R2    = Vector3.new(-485, -5,  26)  -- ✅ تم التحديث
local R_END = Vector3.new(-476, -7, 101)  -- ✅ تم التحديث
...
Notify("H2N Ultimate | ✅ Menu Fixed | ✅ New Coordinates | ✅ Fast Response")
print("=" .. string.rep("=", 65))
